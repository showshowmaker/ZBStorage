...
LAYOUT_OBJECT_REPLICA_COUNT="${LAYOUT_OBJECT_REPLICA_COUNT:-3}"
LAYOUT_OBJECT_SCRUB_ON_LOAD="${LAYOUT_OBJECT_SCRUB_ON_LOAD:-true}"
ENABLE_LAYOUT_GC="${ENABLE_LAYOUT_GC:-false}"
LAYOUT_GC_INTERVAL_MS="${LAYOUT_GC_INTERVAL_MS:-30000}"
LAYOUT_GC_ORPHAN_GRACE_MS="${LAYOUT_GC_ORPHAN_GRACE_MS:-600000}"
...
LAYOUT_OBJECT_REPLICA_COUNT=${LAYOUT_OBJECT_REPLICA_COUNT}
LAYOUT_OBJECT_SCRUB_ON_LOAD=${LAYOUT_OBJECT_SCRUB_ON_LOAD}
ENABLE_LAYOUT_GC=${ENABLE_LAYOUT_GC}
LAYOUT_GC_INTERVAL_MS=${LAYOUT_GC_INTERVAL_MS}
LAYOUT_GC_ORPHAN_GRACE_MS=${LAYOUT_GC_ORPHAN_GRACE_MS}
LAYOUT_GC_MAX_DELETE_PER_ROUND=${LAYOUT_GC_MAX_DELETE_PER_ROUND}
NODES=${MDS_NODES}
DISKS=${MDS_DISKS}
EOF
