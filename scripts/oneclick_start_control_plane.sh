...
ARCHIVE_DISC_SIZE_BYTES=1099511627776
ARCHIVE_STRICT_FULL_DISC=true
ARCHIVE_STAGING_DIR=${DATA_DIR}/mds_archive_staging
ARCHIVE_BATCH_MAX_AGE_MS=0
NODES=node-01@127.0.0.1:${REAL_PORT},type=REAL,weight=1;vpool@127.0.0.1:${VIRTUAL_PORT},type=VIRTUAL,weight=8,virtual_node_count=${VIRTUAL_NODE_COUNT}
DISKS=node-01:${REAL_DISKS_CSV};vpool:${REAL_DISKS_CSV}
EOF
